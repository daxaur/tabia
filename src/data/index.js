...
import { repertoire as bdg } from './bdg.js?v=44';
import { repertoire as jobava } from './jobava.js?v=44';
import { repertoire as budapest } from './budapest.js?v=44';
import { repertoire as qg } from './queensgambit.js?v=44';
import { repertoire as ruylopez } from './ruylopez.js?v=44';
import { repertoire as italian } from './italian.js?v=44';
import { repertoire as sicilian } from './sicilian.js?v=44';
import { repertoire as french } from './french.js?v=44';
import { repertoire as carokann } from './carokann.js?v=44';
import { repertoire as alien } from './alien.js?v=44';
import { repertoire as benoni } from './benoni.js?v=44';
import { repertoire as oldbenoni } from './benonigambit.js?v=44';
