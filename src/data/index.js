...
import { repertoire as bdg } from './bdg.js?v=20';
import { repertoire as jobava } from './jobava.js?v=20';
import { repertoire as budapest } from './budapest.js?v=20';
import { repertoire as qg } from './queensgambit.js?v=20';
import { repertoire as ruylopez } from './ruylopez.js?v=20';
import { repertoire as italian } from './italian.js?v=20';
import { repertoire as sicilian } from './sicilian.js?v=20';
import { repertoire as french } from './french.js?v=20';
import { repertoire as carokann } from './carokann.js?v=20';
import { repertoire as alien } from './alien.js?v=20';

export const openings = [bdg, jobava, budapest, alien, qg, ruylopez, italian, sicilian, french, carokann];
...
const CATEGORY = {
  ...
  sicilian: 'Defences', french: 'Defences', carokann: 'Defences',
};
